...
{
    update_37_to_38($license_code, $purchase_code, $connection);
    sleep(1);
    update_38_to_39($license_code, $purchase_code, $connection);
    sleep(1);
    update_39_to_40($license_code, $purchase_code, $connection);
}

function update_37_to_38($license_code, $purchase_code, $connection)
{
...
function update_38_to_39($license_code, $purchase_code, $connection)
{
...
(32, 'Verdana', NULL, 'font-family: Verdana, Helvetica, sans-serif', 1);";
    ...
    $p = array();
    //version 3.8
    $p["msg_updated"] = "Changes successfully saved!";
    $p["msg_deleted"] = "Item successfully deleted!";
    $p["video"] = "Video";
    $p["add_video"] = "Add Video";
    $p["get_video_from_url"] = "Get Video from Url";
    $p["get_video"] = "Get Video";
    $p["generate"] = "Generate";
    $p["video_url"] = "Video Url";
    $p["video_embed_code"] = "Video Embed Code";
    $p["video_thumbnails"] = "Video Thumbnails";
    $p["video_image"] = "Video Image";
    $p["or"] = "or";
    $p["add_image_url"] = "Add Image Url";
    $p["update_video"] = "Update Video";
    $p["admin_panel_link"] = "Admin Panel Link";
    $p["social_accounts"] = "Social Accounts";
    $p["msg_username_unique_error"] = "The username has already been taken.";
    $p["msg_slug_used"] = "The slug you entered is being used by another user!";
    $p["just_now"] = "Just Now";
    $p["minute_ago"] = "minute ago";
    $p["minutes_ago"] = "minutes ago";
    $p["hour_ago"] = "hour ago";
    $p["hours_ago"] = "hours ago";
    $p["day_ago"] = "day ago";
    $p["days_ago"] = "days ago";
    $p["month_ago"] = "month ago";
    $p["months_ago"] = "months ago";
    $p["year_ago"] = "year ago";
    ...
    $p["member_since"] = "Member since";
    $p["show_email_on_profile"] = "Show Email on Profile Page";
    $p["cache_system"] = "Cache System";
    $p["cache_refresh_time"] = "Cache Refresh Time (Minute)";
    $p["cache_refresh_time_exp"] = "After this time, your cache files will be refreshed.";
    $p["refresh_cache_database_changes"] = "Refresh Cache Files When Database Changes";
    $p["reset_cache"] = "Reset Cache";
    $p["msg_reset_cache"] = "All cache files have been deleted!";
    $p["terms_conditions"] = "Terms & Conditions";
    $p["terms_conditions_exp"] = "I have read and agree to the";
    $p["email_option_contact_messages"] = "Send contact messages to email address";
    $p["admin_emails_will_send"] = "Admin emails will be sent to this address";
    $p["email_options"] = "Email Options";
    $p["gmail_warning"] = "To send e-mails with Gmail server, please read Email Settings section in our documentation.";
    $p["logo_email"] = "Logo Email";
    $p["mail_library"] = "Mail Library";
    $p["contact_message"] = "Contact Message";
    $p["subscribers"] = "Subscribers";
    $p["preview"] = "Preview";
    $p["send_email_subscribers"] = "Send Email to Subscribers";
    $p["msg_subscriber_deleted"] = "Subscriber successfully deleted!";
    $p["confirm_subscriber"] = "Are you sure you want to delete this subscriber?";
    $p["unsubscribe"] = "Unsubscribe";
    $p["unsubscribe_successful"] = "Unsubscribe Successful!";
    $p["msg_unsubscribe"] = "You will no longer receive emails from us!";
    $p["email_reset_password"] = "Please click on the button below to reset your password.";
    $p["msg_reset_password_success"] = "We've sent an email for resetting your password to your email address. Please check your email for next steps.";
    $p["forgot_password"] = "Forgot Password";
    $p["new_password"] = "New Password";
    $p["album"] = "Album";
    $p["albums"] = "Albums";
    $p["gallery_albums"] = "Gallery Albums";
    $p["add_album"] = "Add Album";
    $p["album_name"] = "Album Name";
    $p["msg_delete_album"] = "Please delete categories belonging to this album first!";
    $p["confirm_album"] = "Are you sure you want to delete this album?";
    $p["update_album"] = "Update Album";
    $p["select_multiple_images"] = "You can select multiple images.";
    $p["album_cover"] = "Album Cover";
    $p["set_as_album_cover"] = "Set as Album Cover";
    $p["rss_feeds"] = "RSS Feeds";
    $p["cookies_warning"] = "Cookies Warning";
    $p["show_cookies_warning"] = "Show Cookies Warning";
    $p["uploading"] = "Uploading...";
    $p["add_user"] = "Add User";
    $p["msg_user_added"] = "User successfully added!";
    //version 3.9
    ...
    $p["recently_added_comments"] = "Recently added comments";
    $p["recently_added_unapproved_comments"] = "Recently added unapproved comments";
    $p["recently_added_contact_messages"] = "Recently added contact messages";
    $p["recently_registered_users"] = "Recently registered users";
    ...
    $p["please_select_option"] = "Please select an option!";
    $p["post_owner"] = "Post Owner";
    $p["timezone"] = "Timezone";
    $p["themes"] = "Themes";
    $p["activated"] = "Activated";
    $p["activate"] = "Activate";
    $p["light_mode"] = "Light Mode";
    $p["dark_mode"] = "Dark Mode";
    $p["approve_posts_before_publishing"] = "Approve Posts Before Publishing";
    $p["emoji_reactions_type"] = "Emoji Reactions Type";
    $p["gif_animated"] = "GIF (Animated)";
    $p["png_not_animated"] = "PNG (Not Animated)";
    $p["text_editor_language"] = "Text Editor Language";
    $p["site_language"] = "Site Language";
    $p["social_login_settings"] = "Social Login Settings";
    $p["app_id"] = "App ID";
    $p["app_secret"] = "App Secret";
    $p["client_id"] = "Client ID";
    $p["client_secret"] = "Client Secret";
    $p["connect_with_facebook"] = "Connect with Facebook";
    $p["connect_with_google"] = "Connect with Google";
    $p["or_register_with_email"] = "Or register with email";
    $p["or_login_with_email"] = "Or login with email";
    $p["username_or_email"] = "Username or email";
    $p["msg_register_success"] = "Your account has been created successfully!";
    $p["files"] = "Files";
    $p["files_exp"] = "Downloadable additional files (.pdf, .docx, .zip etc..)";
    $p["select_file"] = "Select File";
    $p["main_post_image"] = "Main post image";
    $p["more_main_images"] = "More main images (slider will be active)";
    $p["upload_image"] = "Upload Image";
    $p["drag_drop_files_here"] = "Drag and drop files here or";
    $p["browse_files"] = "Browse Files";
    $p["txt_processing"] = "Processing...";
    $p["file_upload"] = "File Upload";
    $p["msg_register_character_error"] = "You cannot use the @ character in the username!";
    $p["google_adsense_code"] = "Google Adsense Code";
    $p["edit_translations"] = "Edit Translations";
    //version 4.0
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="install-box">
                        <h2 class="title">Update from v3.7.x to v4.0.2</h2>
                        <br><br>
                        <div class="messages">
                            <?php if (!empty($error)) { ?>
